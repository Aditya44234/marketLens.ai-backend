...
def build_prompt(user_query, filtered_df, analysis_type, locations, years):
    ...
    if analysis_type == "compare":
        return (
            ...
            "Compare the demand/sales trends between the two places and return a summary for a real estate stakeholder."
        )
        ...
        return (
            ...
            f"{prompt_df.to_string(index=False)}\n"
            "Give insights on price growth and trend over this recent period for a stakeholder."
        )
    else:
        return (
            f"User question: {user_query}\n"
            ...
            f"{prompt_df.to_string(index=False)}\n"
            "Please analyze the market trends and return a concise summary for a real estate stakeholder."
        )
